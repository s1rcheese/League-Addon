...
import kassuk.addon.blackout.utils.Constants;
import kassuk.addon.blackout.utils.StarscriptUtils;
...
public class Announcer extends Module {
    ...
    public Announcer() {
        super(BlackOut.CHATPLUS, "announcer", "Announces specified actions into chat.");
    }
    ...
    private class Moving extends Feature {
        private final Setting<String> msg = sg.add(new StringSetting.Builder()
            ...
            .defaultValue("I just flew over [dist] blocks thanks to league!")
    ...
    private class Mining extends Feature {
        private final Setting<String> msg = sg.add(new StringSetting.Builder()
            ...
            .defaultValue("I just destroyed [count] [block] with the power of league!")
            .visible(this::isEnabled)
            .onChanged(e -> compile())
            .renderer(StarscriptTextBoxRenderer.class)
            .build()
